export default function Footer() {
  return (
    <footer className="bg-brand-dark text-white px-4 sm:px-6 py-10">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">

        {/* Logo — white fill on dark bg */}
        <svg width="91" height="40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="MyEdSpace">
        ...
        <nav className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-white">
          ...
          <a
            href="https://www.tiktok.com/@eddiedoesmath"
            target="_blank"
